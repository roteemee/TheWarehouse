...
public class PurchaseOrder {
    ...
    @SequenceGenerator(sequenceName = "po_seq", allocationSize = 1, name = "po")
	...
	public PurchaseOrder(Map<Item, Integer> lineItem, User user, Date orderDate, double totalPrice,
